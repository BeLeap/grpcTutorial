...
import co.riiid.tutorial.grpctutorial.GreeterGrpc.getServiceDescriptor
 ...
 * co.riiid.tutorial.grpctutorial.Greeter.
 */
object GreeterGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) co.riiid.tutorial.grpctutorial.Greeter service as suspending
   * coroutines.
   */
  ...
  /**
   * Skeletal implementation of the co.riiid.tutorial.grpctutorial.Greeter service based on Kotlin
   * coroutines.
   */
  abstract class GreeterCoroutineImplBase(
    ...
    /**
     * Returns the response to an RPC for co.riiid.tutorial.grpctutorial.Greeter.SayHello.
     *
    ...
    open suspend fun sayHello(request: HelloRequest): HelloReply = throw
        StatusException(UNIMPLEMENTED.withDescription("Method co.riiid.tutorial.grpctutorial.Greeter.SayHello is unimplemented"))
